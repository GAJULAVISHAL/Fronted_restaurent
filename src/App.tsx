...
const WaiterPage = lazy(() => import("./Pages/WaiterPage").then((module) => ({ default: module.WaiterPage})));
const PublicMenuPage = lazy(() => import("./Pages/PublicMenuPage").then((module) => ({ default: module.PublicMenuPage })));
